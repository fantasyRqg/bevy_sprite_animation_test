...
use crate::cocos2d_anim::Cocos2dAnimator;
...
// fn new_projectile(projectile_info: &ProjectileInfo, plist_sprite_frame_assets: &Res<Assets<PlistSpriteFrameAsset>>, rng: &mut ThreadRng, hw: f32, hh: f32) -> (SpriteSheetBundle, Cocos2dAnimator, MoveElement, Projectile) {
...
// }
//
// fn new_unit(unit_infos: &Res<UnitInfoRes>, plist_sprite_frame_assets: &Res<Assets<PlistSpriteFrameAsset>>, rng: &mut ThreadRng, hw: f32, hh: f32) -> (SpriteSheetBundle, Cocos2dAnimator, MoveElement, Unit) {
...
fn move_sprite(
    ...
    mut query: Query<(&mut Cocos2dAnimator, &mut TextureAtlasSprite, &mut MoveElement)>,
) {
...
fn projectile_point(
    mut query: Query<(&mut Cocos2dAnimator, &mut TextureAtlasSprite, &mut MoveElement), With<Projectile>>,
) {
